...
}
{
    ...
    if (routeNameNode != undefined) {
        registerNamedRoute(() => new LocalStorageComponent(undefined, {}, storage), routeNameNode, { bundleName: "com.example.application", moduleName: "application", pagePath: "pages/utForPartialUpdate/ui_state_management/application_state_management/localStorage/localStorageForBoth", pageFullPath: "application/entry/src/main/ets/pages/utForPartialUpdate/ui_state_management/application_state_management/localStorage/localStorageForBoth", integratedHsp: "false" });
    }
    else {
        registerNamedRoute(() => new LocalStorageComponent(undefined, {}, storage), "", { bundleName: "com.example.application", moduleName: "application", pagePath: "pages/utForPartialUpdate/ui_state_management/application_state_management/localStorage/localStorageForBoth", pageFullPath: "application/entry/src/main/ets/pages/utForPartialUpdate/ui_state_management/application_state_management/localStorage/localStorageForBoth", integratedHsp: "false" });
    }
}
//# sourceMappingURL=localStorageForBoth.js.map
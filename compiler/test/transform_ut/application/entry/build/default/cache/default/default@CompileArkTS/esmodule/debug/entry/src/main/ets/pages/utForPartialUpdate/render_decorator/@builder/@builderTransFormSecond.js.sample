...
function testInnerComponent(value, parent = null) {
    ...
    commonBuilder.bind(this)();
    {
        (parent ? parent : this).observeComponentCreation2((elmtId, isInitialRender, value = __value__) => {
            if (isInitialRender) {
                let componentCall = new TestBuilderChild(parent ? parent : this, {}, undefined, elmtId, () => { }, { page: "test/transform_ut/application/entry/src/main/ets/pages/utForPartialUpdate/render_decorator/@builder/@builderTransFormSecond.ets", line: 53, col: 5 });
    ...
    }, __Common__);
    {
        (parent ? parent : this).observeComponentCreation2((elmtId, isInitialRender, value = __value__) => {
            if (isInitialRender) {
                let componentCall = new TestBuilderChild(parent ? parent : this, {}, undefined, elmtId, () => { }, { page: "test/transform_ut/application/entry/src/main/ets/pages/utForPartialUpdate/render_decorator/@builder/@builderTransFormSecond.ets", line: 54, col: 5 });
                ViewPU.create(componentCall);
                let paramsLambda = () => {
                    return {};
                };

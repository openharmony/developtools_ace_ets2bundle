    ...
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.dialogController = new CustomDialogController({
            builder: () => {
                ...
                }, undefined, -1, () => { }, { page: "test/transform_ut/application/entry/src/main/ets/pages/utForPartialUpdate/render_decorator/@customDialog/@customDialog.ets", line: 46, col: 14 });

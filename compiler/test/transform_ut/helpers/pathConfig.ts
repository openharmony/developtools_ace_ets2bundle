...
export const UT_PARTIAL_UPFATE_PAGES: string[] = [
  ...
  'inner_component_transform/$$_component/$$_componentCheck8',
  'inner_component_transform/$$_component/$$_componentCheck9',
  'inner_component_transform/$$_component/$$_allComponent',
  'inner_component_transform/$$_component/$$_allComponent1',
  ...
  'render_decorator/@customDialog/@customDialog',
  'render_decorator/@customDialog/actionSheet',
  'render_decorator/@customDialog/alertDialog',
  'render_decorator/@customDialog/calendarPickerDialog',
  'render_decorator/@customDialog/datePickerDialog',
  'render_decorator/@customDialog/textPickerDialog',
  'render_decorator/@customDialog/timePickerDialog',
  'render_decorator/@extend/@extend',
  ...
  'ui_state_management/others/@consume_@provide/@consume_@provide',
  'ui_state_management/others/@consume_@provide/@consume_with_defaultValue',
  'ui_state_management/others/@observed_@objectLink/@observed_@objectLink',
...
export const UT_VALIDATE_PAGES: string[] = [
  ...
  'Decorators/process_component_member/validateForbiddenSpecifyDefaultValue',
  ...
  'Decorators/process_custom_component/checkAssignEnv',
  ...
  'Decorators/process_custom_component/validateLinkVariableSourceDataEachCondition',
  'Decorators/process_custom_component/validateLinkVariableSourceDataEachState',
  'Decorators/process_custom_component/validateLinkVariableSourceDataExtend',
  'Decorators/process_custom_component/validateLinkVariableSourceDataRealize',
  'Decorators/process_custom_component/validateLinkVariableSourceDataObserved',
  ...
  'Decorators/vaildate_ui_syntax/envDuplicateDecorators',
  'Decorators/vaildate_ui_syntax/envInCustomDialog',
  ...
  'Decorators/supplementary_validation/decorator_validation/decorator_validation_workflow_validation',
  'Decorators/supplementary_validation/child_restriction_validation/child_restriction_validation_workflow_validation',
  'Decorators/supplementary_validation/reuse_validation/reuse_validation_workflow_validation',
  'Decorators/supplementary_validation/computed_validation/computed_validation_workflow_validation',
  'Decorators/supplementary_validation/event_validation/event_validation_workflow_validation',
  'Decorators/supplementary_validation/dialog_validation/dialog_validation_workflow_validation',
  'Decorators/supplementary_validation/resource_validation/resource_validation_workflow_validation',

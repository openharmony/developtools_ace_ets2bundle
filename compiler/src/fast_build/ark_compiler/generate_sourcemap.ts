...
export class SourceMapGenerator {
  ...
  public writeModifiedSourceMapToFile(parentEvent: CompileEvent | undefined): void {
    ...
    Object.keys(this.sourceMaps).forEach(key => {
      ...
      let contentJson: string = this.formatOrigin(keyChanged, this.sourceMaps[keyChanged]);
      let contentTmp: string = this.formatTemp(keyChanged, this.sourceMaps[keyChanged]);

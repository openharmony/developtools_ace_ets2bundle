...
export const ERROR_CODE_INFO: Map<string, Omit<SdkHvigorLogInfo, 'cause' | 'position'>> = new Map([
  ...
  [APIAVAILABLE_DISTRIBUTIONOS_CHECK_ERROR, { code: '11706014', description: 'Invalid $RUNTIMEOS version.', solutions: ['Check the official API reference documentation, and switch to the supported interfaces.'] }],

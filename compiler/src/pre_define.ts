...
export const COMPONENT_CUSTOM_ENV_DECORATOR: string = '@CustomEnv';
...
export const INNER_COMPONENT_MEMBER_DECORATORS: Set<string> = new Set([COMPONENT_STATE_DECORATOR,
  ...
  COMPONENT_REQUIRE_DECORATOR, COMPONENT_ENV_DECORATOR, COMPONENT_CUSTOM_ENV_DECORATOR]);
...
export const BIND_OBJECT_PROPERTY: Map<string, Set<string>> = new Map([
  ...
  [ALL_COMPONENTS, new Set(['bindMenu', 'bindContextMenu', 'bindContextMenuByResponseType', 'bindContextMenuByIsShow', 'bindContextMenuWithResponse', 'bindSheet', 'dragPreview'])]
]);
...
export const BIND_CONTEXT_MENU_BY_RESPONSE_TYPE: string = 'bindContextMenuByResponseType';
export const BIND_CONTEXT_MENU_BY_IS_SHOW: string = 'bindContextMenuByIsShow';
...
export const DECORATOR_COMPONENT_REUSEMEMOPT: string = 'memoryOptimizationStrategy';
export const SET_IS_ENABLE_MEM_OPT: string = '__setReusableMemOptStrategy__Internal';

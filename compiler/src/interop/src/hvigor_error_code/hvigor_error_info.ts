...
export const TSC_EXTENSION_CODE = '001'; // Extended Codes Defined by TSC Subsystems
export const LINTER_EXTENSION_CODE = '999'; // Extended Codes Defined by Linter Subsystems

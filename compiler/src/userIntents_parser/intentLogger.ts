...
export const DECORATOR_ILLEGAL_USE: LogData = LogDataFactory.newInstance('1016',
  '[InsightIntent] @InsightIntentFunctionMethod must be declared under the @InsightIntentFunction decorator');
export const DECORATOR_DUPLICATE_INTENTNAME: LogData = LogDataFactory.newInstance('1016',

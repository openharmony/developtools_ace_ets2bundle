...
export enum Es2pandaTokenType {
    TOKEN_TYPE_EOS,
    TOKEN_TYPE_LITERAL_IDENT,
    TOKEN_TYPE_LITERAL_STRING,
    TOKEN_TYPE_LITERAL_CHAR,
    TOKEN_TYPE_LITERAL_NUMBER,
    TOKEN_TYPE_LITERAL_REGEXP,
    TOKEN_TYPE_PUNCTUATOR_BITWISE_AND,
    TOKEN_TYPE_PUNCTUATOR_BITWISE_OR,
    TOKEN_TYPE_PUNCTUATOR_MULTIPLY,
    TOKEN_TYPE_PUNCTUATOR_DIVIDE,
    TOKEN_TYPE_PUNCTUATOR_MINUS,
    TOKEN_TYPE_PUNCTUATOR_EXCLAMATION_MARK,
    TOKEN_TYPE_PUNCTUATOR_TILDE,
    TOKEN_TYPE_PUNCTUATOR_MINUS_MINUS,
    TOKEN_TYPE_PUNCTUATOR_LEFT_SHIFT,
    TOKEN_TYPE_PUNCTUATOR_RIGHT_SHIFT,
    TOKEN_TYPE_PUNCTUATOR_LESS_THAN_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_GREATER_THAN_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_MOD,
    TOKEN_TYPE_PUNCTUATOR_BITWISE_XOR,
    TOKEN_TYPE_PUNCTUATOR_EXPONENTIATION,
    TOKEN_TYPE_PUNCTUATOR_MULTIPLY_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_EXPONENTIATION_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_ARROW,
    TOKEN_TYPE_PUNCTUATOR_BACK_TICK,
    TOKEN_TYPE_PUNCTUATOR_HASH_MARK,
    TOKEN_TYPE_PUNCTUATOR_DIVIDE_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_MOD_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_MINUS_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_LEFT_SHIFT_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_RIGHT_SHIFT_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_UNSIGNED_RIGHT_SHIFT,
    TOKEN_TYPE_PUNCTUATOR_UNSIGNED_RIGHT_SHIFT_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_BITWISE_AND_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_BITWISE_OR_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_LOGICAL_AND_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_NULLISH_COALESCING,
    TOKEN_TYPE_PUNCTUATOR_LOGICAL_OR_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_LOGICAL_NULLISH_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_BITWISE_XOR_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_PLUS,
    TOKEN_TYPE_PUNCTUATOR_PLUS_PLUS,
    TOKEN_TYPE_PUNCTUATOR_PLUS_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_LESS_THAN,
    TOKEN_TYPE_PUNCTUATOR_GREATER_THAN,
    TOKEN_TYPE_PUNCTUATOR_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_NOT_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_STRICT_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_NOT_STRICT_EQUAL,
    TOKEN_TYPE_PUNCTUATOR_LOGICAL_AND,
    TOKEN_TYPE_PUNCTUATOR_LOGICAL_OR,
    TOKEN_TYPE_PUNCTUATOR_SUBSTITUTION,
    TOKEN_TYPE_PUNCTUATOR_QUESTION_MARK,
    TOKEN_TYPE_PUNCTUATOR_QUESTION_DOT,
    TOKEN_TYPE_PUNCTUATOR_AT,
    TOKEN_TYPE_PUNCTUATOR_FORMAT,
    TOKEN_TYPE_PUNCTUATOR_RIGHT_PARENTHESIS,
    TOKEN_TYPE_PUNCTUATOR_LEFT_PARENTHESIS,
    TOKEN_TYPE_PUNCTUATOR_RIGHT_SQUARE_BRACKET,
    TOKEN_TYPE_PUNCTUATOR_LEFT_SQUARE_BRACKET,
    TOKEN_TYPE_PUNCTUATOR_RIGHT_BRACE,
    TOKEN_TYPE_PUNCTUATOR_PERIOD,
    TOKEN_TYPE_PUNCTUATOR_PERIOD_PERIOD_PERIOD,
    TOKEN_TYPE_PUNCTUATOR_PERIOD_QUESTION,
    TOKEN_TYPE_PUNCTUATOR_LEFT_BRACE,
    TOKEN_TYPE_PUNCTUATOR_SEMI_COLON,
    TOKEN_TYPE_PUNCTUATOR_COLON,
    TOKEN_TYPE_PUNCTUATOR_COMMA,
    TOKEN_TYPE_KEYW_ABSTRACT,
    TOKEN_TYPE_KEYW_ANY,
    TOKEN_TYPE_KEYW_ANYREF,
    TOKEN_TYPE_KEYW_ARGUMENTS,
    TOKEN_TYPE_KEYW_AS,
    TOKEN_TYPE_KEYW_ASSERT,
    TOKEN_TYPE_KEYW_ASSERTS,
    TOKEN_TYPE_KEYW_ASYNC,
    TOKEN_TYPE_KEYW_AWAIT,
    TOKEN_TYPE_KEYW_BIGINT,
    TOKEN_TYPE_KEYW_BOOLEAN,
    TOKEN_TYPE_KEYW_BREAK,
    TOKEN_TYPE_KEYW_BYTE,
    TOKEN_TYPE_KEYW_CASE,
    TOKEN_TYPE_KEYW_CATCH,
    TOKEN_TYPE_KEYW_CHAR,
    TOKEN_TYPE_KEYW_CLASS,
    TOKEN_TYPE_KEYW_CONST,
    TOKEN_TYPE_KEYW_CONSTRUCTOR,
    TOKEN_TYPE_KEYW_CONTINUE,
    TOKEN_TYPE_KEYW_DATAREF,
    TOKEN_TYPE_KEYW_DEBUGGER,
    TOKEN_TYPE_KEYW_DECLARE,
    TOKEN_TYPE_KEYW_DEFAULT,
    TOKEN_TYPE_KEYW_DELETE,
    TOKEN_TYPE_KEYW_DO,
    TOKEN_TYPE_KEYW_DOUBLE,
    TOKEN_TYPE_KEYW_ELSE,
    TOKEN_TYPE_KEYW_ENUM,
    TOKEN_TYPE_KEYW_EQREF,
    TOKEN_TYPE_KEYW_EVAL,
    TOKEN_TYPE_KEYW_EXPORT,
    TOKEN_TYPE_KEYW_EXTENDS,
    TOKEN_TYPE_KEYW_EXTERNREF,
    TOKEN_TYPE_KEYW_F32,
    TOKEN_TYPE_KEYW_F64,
    TOKEN_TYPE_LITERAL_FALSE,
    TOKEN_TYPE_KEYW_FINALLY,
    TOKEN_TYPE_KEYW_FLOAT,
    TOKEN_TYPE_KEYW_FOR,
    TOKEN_TYPE_KEYW_FROM,
    TOKEN_TYPE_KEYW_FUNCREF,
    TOKEN_TYPE_KEYW_FUNCTION,
    TOKEN_TYPE_KEYW_GET,
    TOKEN_TYPE_KEYW_GLOBAL,
    TOKEN_TYPE_KEYW_I8,
    TOKEN_TYPE_KEYW_I16,
    ...
    TOKEN_TYPE_KEYW_I64,
    TOKEN_TYPE_KEYW_IF,
    TOKEN_TYPE_KEYW_IMPLEMENTS,
    TOKEN_TYPE_KEYW_IMPORT,
    TOKEN_TYPE_KEYW_IN,
    TOKEN_TYPE_KEYW_INFER,
    TOKEN_TYPE_KEYW_INSTANCEOF,
    TOKEN_TYPE_KEYW_INT,
    TOKEN_TYPE_KEYW_INTERFACE,
    TOKEN_TYPE_KEYW_IS,
    TOKEN_TYPE_KEYW_ISIZE,
    TOKEN_TYPE_KEYW_KEYOF,
    TOKEN_TYPE_KEYW_LET,
    TOKEN_TYPE_KEYW_LONG,
    TOKEN_TYPE_KEYW_META,
    TOKEN_TYPE_KEYW_MODULE,
    TOKEN_TYPE_KEYW_NAMESPACE,
    TOKEN_TYPE_KEYW_NATIVE,
    TOKEN_TYPE_KEYW_NEVER,
    TOKEN_TYPE_KEYW_NEW,
    TOKEN_TYPE_LITERAL_NULL,
    TOKEN_TYPE_KEYW_NUMBER,
    TOKEN_TYPE_KEYW_OBJECT,
    TOKEN_TYPE_KEYW_OF,
    TOKEN_TYPE_KEYW_FINAL,
    TOKEN_TYPE_KEYW_OUT,
    TOKEN_TYPE_KEYW_OVERRIDE,
    TOKEN_TYPE_KEYW_PACKAGE,
    TOKEN_TYPE_KEYW_INTERNAL,
    TOKEN_TYPE_KEYW_PRIVATE,
    TOKEN_TYPE_KEYW_PROTECTED,
    TOKEN_TYPE_KEYW_PUBLIC,
    TOKEN_TYPE_KEYW_READONLY,
    TOKEN_TYPE_KEYW_RETHROWS,
    TOKEN_TYPE_KEYW_RETURN,
    TOKEN_TYPE_KEYW_REQUIRE,
    TOKEN_TYPE_KEYW_SET,
    TOKEN_TYPE_KEYW_SHORT,
    TOKEN_TYPE_KEYW_STATIC,
    TOKEN_TYPE_KEYW_STRING,
    TOKEN_TYPE_KEYW_STRUCT,
    TOKEN_TYPE_KEYW_SUPER,
    TOKEN_TYPE_KEYW_SWITCH,
    TOKEN_TYPE_KEYW_TARGET,
    TOKEN_TYPE_KEYW_THIS,
    TOKEN_TYPE_KEYW_THROW,
    TOKEN_TYPE_KEYW_THROWS,
    TOKEN_TYPE_LITERAL_TRUE,
    TOKEN_TYPE_KEYW_TRY,
    TOKEN_TYPE_KEYW_TYPE,
    TOKEN_TYPE_KEYW_TYPEOF,
    TOKEN_TYPE_KEYW_U8,
    TOKEN_TYPE_KEYW_U16,
    TOKEN_TYPE_KEYW_U32,
    TOKEN_TYPE_KEYW_U64,
    TOKEN_TYPE_KEYW_UNDEFINED,
    TOKEN_TYPE_KEYW_UNKNOWN,
    TOKEN_TYPE_KEYW_USIZE,
    TOKEN_TYPE_KEYW_V128,
    TOKEN_TYPE_KEYW_VAR,
    TOKEN_TYPE_KEYW_VOID,
    TOKEN_TYPE_KEYW_WHILE,
    TOKEN_TYPE_KEYW_WITH,
    TOKEN_TYPE_KEYW_YIELD,
    TOKEN_TYPE_FIRST_PUNCTUATOR = Es2pandaTokenType.TOKEN_TYPE_PUNCTUATOR_BITWISE_AND,
    TOKEN_TYPE_FIRST_KEYW = Es2pandaTokenType.TOKEN_TYPE_KEYW_ABSTRACT
}
...
export enum Es2pandaCompilationMode {
    ...
    COMPILATION_MODE_SIMULTANEOUS = 3
}

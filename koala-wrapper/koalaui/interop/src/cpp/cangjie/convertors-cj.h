...
#define MAKE_CJ_EXPORT(name, type, flag)                                                               \
    __attribute__((constructor)) static void __init_ets_##name()                                       \
    {                                                                                                  \
...
struct InteropTypeConverter {
    using InteropType = T;
    static inline T convertFrom(InteropType value)
    {
        return value;
    }
    static inline InteropType convertTo(T value)
    {
        return value;
    }
};
...
// MAKE_CJ_EXPORT(name, #Ret "|" #P0 "|" #P1 "|" #P2 "|" #P3 "|" #P4 "|" #P5 "|" #P6 "|" #P7 "|" #P8 "|" #P9 "|" #P10,
// 0)

...
exports.CustomTextDecoder = exports.CustomTextEncoder = void 0;
class CustomTextEncoder {
    constructor(encoder = ((typeof TextEncoder != "undefined") ? new TextEncoder() : undefined)) {
    ...
    encodeInto(input, result, position) {
...
CustomTextEncoder.HeaderLen = Int32Array.BYTES_PER_ELEMENT;
class CustomTextDecoder {
    constructor(decoder = ((typeof TextDecoder != "undefined") ? new TextDecoder() : undefined)) {

...
inline ElemType* getTypedElements(JSContextRef context, const JSValueRef arguments)
{
    ...
    ElemType* data = reinterpret_cast<ElemType*>(
        JSObjectGetTypedArrayBytesPtr(context, JSValueToObject(context, arguments, &exception), &exception));
    return data;
}
...
template<>
inline uint32_t getArgument<uint32_t>(
    JSContextRef context, size_t argumentCount, const JSValueRef arguments[], int index)
{
    ASSERT(index < argumentCount);
...
template<>
inline KNativePointer getArgument<KNativePointer>(
    JSContextRef context, size_t argumentCount, const JSValueRef arguments[], int index)
{
    ASSERT(index < argumentCount);
...
template<>
inline KStringPtr getArgument<KStringPtr>(
    JSContextRef context, size_t argumentCount, const JSValueRef arguments[], int index)
{
    ASSERT(index < argumentCount);
...
template<>
inline KBoolean getArgument<KBoolean>(
    JSContextRef context, size_t argumentCount, const JSValueRef arguments[], int index)
{
    ASSERT(index < argumentCount);
...
template<>
inline KStringArray getArgument<KStringArray>(
    JSContextRef context, size_t argumentCount, const JSValueRef arguments[], int index)
{
    ASSERT(index < argumentCount);
...
template<>
inline KUShort* getArgument<KUShort*>(
    JSContextRef context, size_t argumentCount, const JSValueRef arguments[], int index)
{
    ASSERT(index < argumentCount);
...
template<>
inline KNativePointerArray getArgument<KNativePointerArray>(
    JSContextRef context, size_t argumentCount, const JSValueRef arguments[], int index)
{
    ASSERT(index < argumentCount);
...
typedef JSValueRef (*jsc_type_t)(JSContextRef ctx, JSObjectRef function, JSObjectRef thisObject, size_t argumentCount,

...
struct __ani_interaction_api {
    ...
    ani_status (*Object_New_A)(
        ani_env* env, ani_class cls, ani_method method, ani_object* result, const ani_value* args);
     ...
     * @deprecated
     */
    ani_status (*Array_GetRegion_Boolean)(
        ani_env* env, ani_array_boolean array, ani_size offset, ani_size length, ani_boolean* native_buffer);
     ...
     * @deprecated
     */
    ani_status (*Array_GetRegion_Char)(
        ani_env* env, ani_array_char array, ani_size offset, ani_size length, ani_char* native_buffer);
     ...
     * @deprecated
     */
    ani_status (*Array_GetRegion_Byte)(
        ani_env* env, ani_array_byte array, ani_size offset, ani_size length, ani_byte* native_buffer);
     ...
     * @deprecated
     */
    ani_status (*Array_GetRegion_Int)(
        ani_env* env, ani_array_int array, ani_size offset, ani_size length, ani_int* native_buffer);
    ...
    ani_status (*Array_GetRegion_Long)(
        ani_env* env, ani_array_long array, ani_size offset, ani_size length, ani_long* native_buffer);
     ...
     * @deprecated
     */
    ani_status (*Array_GetRegion_Float)(
        ani_env* env, ani_array_float array, ani_size offset, ani_size length, ani_float* native_buffer);
     ...
     * @deprecated
     */
    ani_status (*Array_GetRegion_Double)(
        ani_env* env, ani_array_double array, ani_size offset, ani_size length, ani_double* native_buffer);
    ...
    ani_status (*Array_SetRegion_Boolean)(
        ani_env* env, ani_array_boolean array, ani_size offset, ani_size length, const ani_boolean* native_buffer);
     ...
     * @deprecated
     */
    ani_status (*Array_SetRegion_Char)(
        ani_env* env, ani_array_char array, ani_size offset, ani_size length, const ani_char* native_buffer);
     ...
     * @deprecated
     */
    ani_status (*Array_SetRegion_Byte)(
        ani_env* env, ani_array_byte array, ani_size offset, ani_size length, const ani_byte* native_buffer);
     ...
     * @deprecated
     */
    ani_status (*Array_SetRegion_Int)(
        ani_env* env, ani_array_int array, ani_size offset, ani_size length, const ani_int* native_buffer);
     ...
     * @deprecated
     */
    ani_status (*Array_SetRegion_Long)(
        ani_env* env, ani_array_long array, ani_size offset, ani_size length, const ani_long* native_buffer);
     ...
     * @deprecated
     */
    ani_status (*Array_SetRegion_Float)(
        ani_env* env, ani_array_float array, ani_size offset, ani_size length, const ani_float* native_buffer);
     ...
     * @deprecated
     */
    ani_status (*Array_SetRegion_Double)(
        ani_env* env, ani_array_double array, ani_size offset, ani_size length, const ani_double* native_buffer);
     ...
     * @deprecated
     */
    ani_status (*Array_New_Ref)(
        ani_env* env, ani_type type, ani_size length, ani_ref initial_element, ani_array_ref* result);
...
struct __ani_env {
    ...
    ani_status Array_GetRegion_Boolean(
        ani_array_boolean array, ani_size offset, ani_size length, ani_boolean* native_buffer)
    {
    ...
    ani_status Array_GetRegion_Double(
        ani_array_double array, ani_size offset, ani_size length, ani_double* native_buffer)
    {
        return c_api->Array_GetRegion_Double(this, array, offset, length, native_buffer);
    }
    ani_status Array_SetRegion_Boolean(
        ani_array_boolean array, ani_size offset, ani_size length, const ani_boolean* native_buffer)
    {
        return c_api->Array_SetRegion_Boolean(this, array, offset, length, native_buffer);
    }
    ani_status Array_SetRegion_Char(
        ani_array_char array, ani_size offset, ani_size length, const ani_char* native_buffer)
    {
        return c_api->Array_SetRegion_Char(this, array, offset, length, native_buffer);
    }
    ani_status Array_SetRegion_Byte(
        ani_array_byte array, ani_size offset, ani_size length, const ani_byte* native_buffer)
    {
        return c_api->Array_SetRegion_Byte(this, array, offset, length, native_buffer);
    }
    ani_status Array_SetRegion_Short(
        ani_array_short array, ani_size offset, ani_size length, const ani_short* native_buffer)
    {
    ...
    ani_status Array_SetRegion_Long(
        ani_array_long array, ani_size offset, ani_size length, const ani_long* native_buffer)
    {
        return c_api->Array_SetRegion_Long(this, array, offset, length, native_buffer);
    }
    ani_status Array_SetRegion_Float(
        ani_array_float array, ani_size offset, ani_size length, const ani_float* native_buffer)
    {
        return c_api->Array_SetRegion_Float(this, array, offset, length, native_buffer);
    }
    ani_status Array_SetRegion_Double(
        ani_array_double array, ani_size offset, ani_size length, const ani_double* native_buffer)
    {

...
struct InteropTypeConverter<KBoolean> {
    ...
    static KBoolean convertFrom(InteropType value)
    {
        return value;
    }
    static InteropType convertTo(KBoolean value)
    {
        return value;
    }
...
struct InteropTypeConverter<KInt> {
    ...
    static InteropType convertTo(KInt value)
    {
        return value;
    }
...
struct InteropTypeConverter<KUInt> {
    ...
    static KUInt convertFrom(InteropType value)
    {
        return value;
    }
    static InteropType convertTo(KUInt value)
    {
        return value;
    }
...
struct InteropTypeConverter<KByte> {
    ...
    static InteropType convertTo(KByte value)
    {
        return value;
    }
...
struct InteropTypeConverter<KFloat> {
    ...
    static InteropType convertTo(InteropFloat32 value)
    {
        return value;
    }
...
struct InteropTypeConverter<KDouble> {
    ...
    static KDouble convertFrom(InteropType value)
    {
        return value;
    }
    static InteropType convertTo(InteropFloat64 value)
    {
        return value;
    }
...
#define KOALA_INTEROP_V2(name, P0, P1)                                                                          \
    KOALA_INTEROP_EXPORT void name(                                                                             \
        typename InteropTypeConverter<P0>::InteropType _p0, typename InteropTypeConverter<P1>::InteropType _p1) \
    {                                                                                                           \
        KOALA_MAYBE_LOG(name)                                                                                   \
        P0 p0 = getArgument<P0>(_p0);                                                                           \
        P1 p1 = getArgument<P1>(_p1);                                                                           \
...
#define KOALA_INTEROP_V3(name, P0, P1, P2)                                                                      \
    KOALA_INTEROP_EXPORT void name(typename InteropTypeConverter<P0>::InteropType _p0,                          \
        typename InteropTypeConverter<P1>::InteropType _p1, typename InteropTypeConverter<P2>::InteropType _p2) \
    {                                                                                                           \
        KOALA_MAYBE_LOG(name)                                                                                   \
        P0 p0 = getArgument<P0>(_p0);                                                                           \
        P1 p1 = getArgument<P1>(_p1);                                                                           \
...
#define KOALA_INTEROP_V5(name, P0, P1, P2, P3, P4)                                                              \
    KOALA_INTEROP_EXPORT void name(typename InteropTypeConverter<P0>::InteropType _p0,                          \
        typename InteropTypeConverter<P1>::InteropType _p1, typename InteropTypeConverter<P2>::InteropType _p2, \
        typename InteropTypeConverter<P3>::InteropType _p3, typename InteropTypeConverter<P4>::InteropType _p4) \
    {                                                                                                           \
        KOALA_MAYBE_LOG(name)                                                                                   \
        P0 p0 = getArgument<P0>(_p0);                                                                           \
        P1 p1 = getArgument<P1>(_p1);                                                                           \
...
#define KOALA_INTEROP_V7(name, P0, P1, P2, P3, P4, P5, P6)                                                      \
    KOALA_INTEROP_EXPORT void name(typename InteropTypeConverter<P0>::InteropType _p0,                          \
        typename InteropTypeConverter<P1>::InteropType _p1, typename InteropTypeConverter<P2>::InteropType _p2, \
        typename InteropTypeConverter<P3>::InteropType _p3, typename InteropTypeConverter<P4>::InteropType _p4, \
        typename InteropTypeConverter<P5>::InteropType _p5, typename InteropTypeConverter<P6>::InteropType _p6) \
    {                                                                                                           \
        KOALA_MAYBE_LOG(name)                                                                                   \
        P0 p0 = getArgument<P0>(_p0);                                                                           \
        P1 p1 = getArgument<P1>(_p1);                                                                           \
...
#define KOALA_INTEROP_V9(name, P0, P1, P2, P3, P4, P5, P6, P7, P8)                                              \
    KOALA_INTEROP_EXPORT void name(typename InteropTypeConverter<P0>::InteropType _p0,                          \
        ...
        typename InteropTypeConverter<P3>::InteropType _p3, typename InteropTypeConverter<P4>::InteropType _p4, \
        typename InteropTypeConverter<P5>::InteropType _p5, typename InteropTypeConverter<P6>::InteropType _p6, \
        typename InteropTypeConverter<P7>::InteropType _p7, typename InteropTypeConverter<P8>::InteropType _p8) \
    {                                                                                                           \
        KOALA_MAYBE_LOG(name)                                                                                   \
        P0 p0 = getArgument<P0>(_p0);                                                                           \
        P1 p1 = getArgument<P1>(_p1);                                                                           \
...
#define KOALA_INTEROP_V11(name, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10)                                      \
    KOALA_INTEROP_EXPORT void name(typename InteropTypeConverter<P0>::InteropType _p0,                            \
        ...
        typename InteropTypeConverter<P5>::InteropType _p5, typename InteropTypeConverter<P6>::InteropType _p6,   \
        typename InteropTypeConverter<P7>::InteropType _p7, typename InteropTypeConverter<P8>::InteropType _p8,   \
        typename InteropTypeConverter<P9>::InteropType _p9, typename InteropTypeConverter<P10>::InteropType _p10) \
    {                                                                                                             \
        KOALA_MAYBE_LOG(name)                                                                                     \
        P0 p0 = getArgument<P0>(_p0);                                                                             \
        P1 p1 = getArgument<P1>(_p1);                                                                             \
...
#define KOALA_INTEROP_V13(name, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12)                              \
    KOALA_INTEROP_EXPORT void name(typename InteropTypeConverter<P0>::InteropType _p0,                              \
        ...
        typename InteropTypeConverter<P7>::InteropType _p7, typename InteropTypeConverter<P8>::InteropType _p8,     \
        typename InteropTypeConverter<P9>::InteropType _p9, typename InteropTypeConverter<P10>::InteropType _p10,   \
        typename InteropTypeConverter<P11>::InteropType _p11, typename InteropTypeConverter<P12>::InteropType _p12) \
    {                                                                                                               \
        KOALA_MAYBE_LOG(name)                                                                                       \
        P0 p0 = getArgument<P0>(_p0);                                                                               \
        P1 p1 = getArgument<P1>(_p1);                                                                               \

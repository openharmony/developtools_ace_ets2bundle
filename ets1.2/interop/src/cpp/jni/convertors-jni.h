...
class JniExports {
    std::unordered_map<std::string, std::vector<std::tuple<std::string, std::string, void*>>> implementations;
...
#define MAKE_JNI_EXPORT(module, name, type)                                                  \
    ...
    {                                                                                        \
        JniExports::getInstance()->addMethod(                                                \
            KOALA_QUOTE(module), "_" #name, type, reinterpret_cast<void*>(Java_org_##name)); \
    }                                                                                        \
    namespace {                                                                              \
    struct __Init_##name {                                                                   \
        __Init_##name()                                                                      \
...
#else
#define MAKE_JNI_EXPORT(module, name, type)                                                  \
    __attribute__((constructor)) static void __init_jni_##name()                             \
    {                                                                                        \
        JniExports::getInstance()->addMethod(                                                \
            KOALA_QUOTE(module), "_" #name, type, reinterpret_cast<void*>(Java_org_##name)); \
    }
...
struct InteropTypeConverter {
    using InteropType = T;
    static T convertFrom(JNIEnv* env, InteropType value)
    {
        return value;
    }
    static InteropType convertTo(JNIEnv* env, T value)
    {
        return value;
    }
...
struct SlowInteropTypeConverter {
    using InteropType = T;
    static inline T convertFrom(JNIEnv* env, InteropType value)
    {
        return value;
    }
    static inline InteropType convertTo(JNIEnv* env, T value)
    {
        return value;
    }
    static void release(JNIEnv* env, InteropType value, T converted) {}
...
struct SlowInteropTypeConverter<KInteropBuffer> {
    ...
    static inline KInteropBuffer convertFrom(JNIEnv* env, InteropType value)
    {
        ...
        KInteropBuffer result(
            { env->GetArrayLength(value), reinterpret_cast<KByte*>(env->GetPrimitiveArrayCritical(value, nullptr)) });
        return result;
    }
...
#define KOALA_INTEROP_1(name, Ret, P0)                                                       \
    ...
    Java_org_##name(JNIEnv* env, jclass instance, InteropTypeConverter<P0>::InteropType _p0) \
    {                                                                                        \
        KOALA_MAYBE_LOG(name)                                                                \
...
#define KOALA_INTEROP_9(name, Ret, P0, P1, P2, P3, P4, P5, P6, P7, P8)                                        \
    ...
    MAKE_JNI_EXPORT(                                                                                          \
        KOALA_INTEROP_MODULE, name, #Ret "|" #P0 "|" #P1 "|" #P2 "|" #P3 "|" #P4 "|" #P5 "|" #P6 "|" #P7 "|" #P8)
...
#define KOALA_INTEROP_10(name, Ret, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9)                                       \
    ...
    MAKE_JNI_EXPORT(KOALA_INTEROP_MODULE, name,                                                                   \
        #Ret "|" #P0 "|" #P1 "|" #P2 "|" #P3 "|" #P4 "|" #P5 "|" #P6 "|" #P7 "|" #P8 "|" #P9)
...
#define KOALA_INTEROP_11(name, Ret, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10)                                       \
    ...
    MAKE_JNI_EXPORT(KOALA_INTEROP_MODULE, name,                                                                        \
        #Ret "|" #P0 "|" #P1 "|" #P2 "|" #P3 "|" #P4 "|" #P5 "|" #P6 "|" #P7 "|" #P8 "|" #P9 "|" #P10)
...
#define KOALA_INTEROP_12(name, Ret, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11)                                 \
    ...
    {                                                                                                                 \
        ...
        auto rv =                                                                                                     \
            InteropTypeConverter<Ret>::convertTo(env, impl_##name(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11)); \
        releaseArgument(env, _p0, p0);                                                                                \
        releaseArgument(env, _p1, p1);                                                                                \
        releaseArgument(env, _p2, p2);                                                                                \
        releaseArgument(env, _p3, p3);                                                                                \
...
#define KOALA_INTEROP_13(name, Ret, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12)                     \
    ...
    {                                                                                                          \
        ...
        auto rv = InteropTypeConverter<Ret>::convertTo(                                                        \
            env, impl_##name(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12));                          \
        releaseArgument(env, _p0, p0);                                                                         \
        releaseArgument(env, _p1, p1);                                                                         \
        releaseArgument(env, _p2, p2);                                                                         \
        releaseArgument(env, _p3, p3);                                                                         \
...
#define KOALA_INTEROP_14(name, Ret, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13)                \
    ...
    {                                                                                                          \
        ...
        auto rv = InteropTypeConverter<Ret>::convertTo(                                                        \
            env, impl_##name(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13));                     \
        releaseArgument(env, _p0, p0);                                                                         \
        releaseArgument(env, _p1, p1);                                                                         \
        releaseArgument(env, _p2, p2);                                                                         \
        releaseArgument(env, _p3, p3);                                                                         \
...
#define KOALA_INTEROP_V1(name, P0)                                                                                \
    KOALA_JNI_CALL(void) Java_org_##name(JNIEnv* env, jclass instance, InteropTypeConverter<P0>::InteropType _p0) \
    {                                                                                                             \
        KOALA_MAYBE_LOG(name)                                                                                     \
        P0 p0 = getArgument<P0>(env, _p0);                                                                        \
        impl_##name(p0);                                                                                          \
...
#define KOALA_INTEROP_V9(name, P0, P1, P2, P3, P4, P5, P6, P7, P8)                            \
    ...
    MAKE_JNI_EXPORT(                                                                          \
        KOALA_INTEROP_MODULE, name, "void|" #P0 "|" #P1 "|" #P2 "|" #P3 "|" #P4 "|" #P5 "|" #P6 "|" #P7 "|" #P8)
...
#define KOALA_INTEROP_CTX_1(name, Ret, P0)                                                       \
    KOALA_JNI_CALL(SlowInteropTypeConverter<Ret>::InteropType)                                   \
    Java_org_##name(JNIEnv* env, jclass instance, SlowInteropTypeConverter<P0>::InteropType _p0) \
    {                                                                                            \
        KOALA_MAYBE_LOG(name)                                                                    \
        P0 p0 = getArgument<P0>(env, _p0);                                                       \
        KVMContext ctx = (KVMContext)env;                                                        \
...
#define KOALA_INTEROP_CTX_3(name, Ret, P0, P1, P2)                                                    \
    KOALA_JNI_CALL(SlowInteropTypeConverter<Ret>::InteropType)                                        \
    Java_org_##name(JNIEnv* env, jclass instance, SlowInteropTypeConverter<P0>::InteropType _p0,      \
        SlowInteropTypeConverter<P1>::InteropType _p1, SlowInteropTypeConverter<P2>::InteropType _p2) \
    {                                                                                                 \
        KOALA_MAYBE_LOG(name)                                                                         \
        P0 p0 = getArgument<P0>(env, _p0);                                                            \
        P1 p1 = getArgument<P1>(env, _p1);                                                            \
...
#define KOALA_INTEROP_CTX_5(name, Ret, P0, P1, P2, P3, P4)                                             \
    ...
    Java_org_##name(JNIEnv* env, jclass instance, SlowInteropTypeConverter<P0>::InteropType _p0,       \
        SlowInteropTypeConverter<P1>::InteropType _p1, SlowInteropTypeConverter<P2>::InteropType _p2,  \
        SlowInteropTypeConverter<P3>::InteropType _p3, SlowInteropTypeConverter<P4>::InteropType _p4)  \
    {                                                                                                  \
        KOALA_MAYBE_LOG(name)                                                                          \
        P0 p0 = getArgument<P0>(env, _p0);                                                             \
        P1 p1 = getArgument<P1>(env, _p1);                                                             \
...
#define KOALA_INTEROP_CTX_V1(name, P0)                                                                                \
    KOALA_JNI_CALL(void) Java_org_##name(JNIEnv* env, jclass instance, SlowInteropTypeConverter<P0>::InteropType _p0) \
    {                                                                                                                 \
        KOALA_MAYBE_LOG(name)                                                                                         \
        P0 p0 = getArgument<P0>(env, _p0);                                                                            \
        KVMContext ctx = (KVMContext)env;                                                                             \
...
#define KOALA_INTEROP_DIRECT_0(name, Ret) KOALA_INTEROP_0(name, Ret)
#define KOALA_INTEROP_DIRECT_1(name, Ret, P0) KOALA_INTEROP_1(name, Ret, P0)
#define KOALA_INTEROP_DIRECT_2(name, Ret, P0, P1) KOALA_INTEROP_2(name, Ret, P0, P1)
#define KOALA_INTEROP_DIRECT_3(name, Ret, P0, P1, P2) KOALA_INTEROP_3(name, Ret, P0, P1, P2)
#define KOALA_INTEROP_DIRECT_4(name, Ret, P0, P1, P2, P3) KOALA_INTEROP_4(name, Ret, P0, P1, P2, P3)
#define KOALA_INTEROP_DIRECT_5(name, Ret, P0, P1, P2, P3, P4) KOALA_INTEROP_5(name, Ret, P0, P1, P2, P3, P4)
#define KOALA_INTEROP_DIRECT_6(name, Ret, P0, P1, P2, P3, P4, P5) KOALA_INTEROP_6(name, Ret, P0, P1, P2, P3, P4, P5)
...
#define KOALA_INTEROP_DIRECT_V0(name) KOALA_INTEROP_V0(name)
#define KOALA_INTEROP_DIRECT_V1(name, P0) KOALA_INTEROP_V1(name, P0)
#define KOALA_INTEROP_DIRECT_V2(name, P0, P1) KOALA_INTEROP_V2(name, P0, P1)
#define KOALA_INTEROP_DIRECT_V3(name, P0, P1, P2) KOALA_INTEROP_V3(name, P0, P1, P2)
#define KOALA_INTEROP_DIRECT_V4(name, P0, P1, P2, P3) KOALA_INTEROP_V4(name, P0, P1, P2, P3)
#define KOALA_INTEROP_DIRECT_V5(name, P0, P1, P2, P3, P4) KOALA_INTEROP_V5(name, P0, P1, P2, P3, P4)
#define KOALA_INTEROP_DIRECT_V6(name, P0, P1, P2, P3, P4, P5) KOALA_INTEROP_V6(name, P0, P1, P2, P3, P4, P5)
#define KOALA_INTEROP_DIRECT_V7(name, P0, P1, P2, P3, P4, P5, P6) KOALA_INTEROP_V7(name, P0, P1, P2, P3, P4, P5, P6)
...
bool setKoalaJniCallbackDispatcher(
    JNIEnv* env, jclass clazz, const char* dispatcherMethodName, const char* dispactherMethodSig);

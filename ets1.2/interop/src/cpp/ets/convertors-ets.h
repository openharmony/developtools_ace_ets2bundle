...
struct InteropTypeConverter<KBoolean> {
    ...
    static KBoolean convertFrom(EtsEnv* env, InteropType value)
    {
        return value;
    }
    static InteropType convertTo(EtsEnv* env, KBoolean value)
    {
        return value;
    }
...
struct InteropTypeConverter<KInt> {
    ...
    static InteropType convertTo(EtsEnv* env, KInt value)
    {
        return value;
    }
...
struct InteropTypeConverter<KUInt> {
    using InteropType = ets_int;
    static KUInt convertFrom(EtsEnv* env, InteropType value)
    {
        return value;
    }
    static InteropType convertTo(EtsEnv* env, KUInt value)
    {
        return value;
    }
...
struct InteropTypeConverter<KByte> {
    ...
    static InteropType convertTo(EtsEnv* env, KByte value)
    {
        return value;
    }
...
struct InteropTypeConverter<KFloat> {
    ...
    static InteropType convertTo(EtsEnv* env, InteropFloat32 value)
    {
        return value;
    }
...
struct InteropTypeConverter<KDouble> {
    ...
    static KDouble convertFrom(EtsEnv* env, InteropType value)
    {
        return value;
    }
    static InteropType convertTo(EtsEnv* env, InteropFloat64 value)
    {
        return value;
    }
...
struct DirectInteropTypeConverter {
    using InteropType = T;
    static T convertFrom(InteropType value)
    {
        return value;
    }
    static InteropType convertTo(T value)
    {
        return value;
    }
};
...
#define MAKE_ETS_EXPORT(module, name, type, flag)                                             \
    ...
    {                                                                                         \
        EtsExports::getInstance()->addMethod(                                                 \
            KOALA_QUOTE(module), "_" #name, type, reinterpret_cast<void*>(Ark_##name), flag); \
    }                                                                                         \
    namespace {                                                                               \
    struct __Init_##name {                                                                    \
        __Init_##name()                                                                       \
...
#define KOALA_ETS_INTEROP_MODULE_CLASSPATH(module, classpath)                    \
    __attribute__((constructor)) static void __init_ets_classpath_##module()     \
    {                                                                            \
        EtsExports::getInstance()->setClasspath(KOALA_QUOTE(module), classpath); \
    }
#endif
...
#define KOALA_INTEROP_1(name, Ret, P0)                                           \
    InteropTypeConverter<Ret>::InteropType Ark_##name(                           \
        EtsEnv* env, ets_class clazz, InteropTypeConverter<P0>::InteropType _p0) \
    {                                                                            \
        KOALA_MAYBE_LOG(name)                                                    \
...
#define KOALA_INTEROP_8(name, Ret, P0, P1, P2, P3, P4, P5, P6, P7)                                            \
    InteropTypeConverter<Ret>::InteropType Ark_##name(EtsEnv* env, InteropTypeConverter<P0>::InteropType _p0, \
...
#define KOALA_INTEROP_10(name, Ret, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9)                   \
    ...
    MAKE_ETS_EXPORT(KOALA_INTEROP_MODULE, name,                                               \
...
#define KOALA_INTEROP_V1(name, P0)                                                           \
    void Ark_##name(EtsEnv* env, ets_class clazz, InteropTypeConverter<P0>::InteropType _p0) \
    {                                                                                        \
        KOALA_MAYBE_LOG(name)                                                                \
        P0 p0 = getArgument<P0>(env, _p0);                                                   \
        impl_##name(p0);                                                                     \
...
#define KOALA_INTEROP_DIRECT_1(name, Ret, P0)                                                          \
    inline InteropTypeConverter<Ret>::InteropType Ark_##name(InteropTypeConverter<P0>::InteropType p0) \
    {                                                                                                  \
        KOALA_MAYBE_LOG(name)                                                                          \
...
#define KOALA_INTEROP_DIRECT_V1(name, P0)                             \
    inline void Ark_##name(InteropTypeConverter<P0>::InteropType p0)  \
    {                                                                 \
        KOALA_MAYBE_LOG(name)                                         \
        impl_##name(DirectInteropTypeConverter<P0>::convertFrom(p0)); \
    }                                                                 \
...
#define KOALA_INTEROP_DIRECT_V2(name, P0, P1)                                                                          \
    inline void Ark_##name(InteropTypeConverter<P0>::InteropType p0, InteropTypeConverter<P1>::InteropType p1)         \
    {                                                                                                                  \
        KOALA_MAYBE_LOG(name)                                                                                          \
...
bool setKoalaEtsNapiCallbackDispatcher(
    EtsEnv* etsEnv, ets_class clazz, const char* dispatcherMethodName, const char* dispactherMethodSig);

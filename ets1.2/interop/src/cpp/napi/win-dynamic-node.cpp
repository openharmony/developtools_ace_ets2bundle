...
NAPI_EXTERN napi_status NAPI_CDECL napi_get_last_error_info(napi_env env, const napi_extended_error_info** result)
{
    LoadNapiFunctions();
...
NAPI_EXTERN napi_status NAPI_CDECL napi_get_typedarray_info(napi_env env, napi_value typedarray,
...
NAPI_EXTERN NAPI_NO_RETURN void NAPI_CDECL napi_fatal_error(
...
NAPI_EXTERN napi_status NAPI_CDECL napi_create_typedarray(napi_env env, napi_typedarray_type type, size_t length,
...
NAPI_EXTERN napi_status NAPI_CDECL napi_create_async_work(napi_env env, napi_value async_resource,
...
NAPI_EXTERN napi_status NAPI_CDECL napi_queue_async_work(napi_env env, napi_async_work work)
{
    LoadNapiFunctions();
...
NAPI_EXTERN napi_status NAPI_CDECL napi_create_threadsafe_function(napi_env env, napi_value func,
    napi_value async_resource, napi_value async_resource_name, size_t max_queue_size, size_t initial_thread_count,
    ...
    napi_threadsafe_function_call_js call_js_cb, napi_threadsafe_function* result)
{
    ...
    return p_napi_create_threadsafe_function(env, func, async_resource, async_resource_name, max_queue_size,
        initial_thread_count, thread_finalize_data, thread_finalize_cb, context, call_js_cb, result);
}
...
NAPI_EXTERN napi_status NAPI_CDECL napi_cancel_async_work(napi_env env, napi_async_work work)
{
    LoadNapiFunctions();

...
const K = [0x5a827999 | 0, 0x6ed9eba1 | 0, 0x8f1bbcdc | 0, 0xca62c1d6 | 0];
...
export class SHA1Hash {
    private A = int64to32(0x67452301);
    private B = int64to32(0xefcdab89);
    private C = int64to32(0x98badcfe);
    private D = int64to32(0x10325476);
    private E = int64to32(0xc3d2e1f0);
    ...
    update(data: Int32Array | Float32Array | Uint32Array | Uint8Array): SHA1Hash {
        ...
        if (BYTES_PER_ELEMENT !== 1 && (buffer !== undefined && buffer !== null)) {
...
const swapLE: NN = (c: int32): int32 =>
    int64to32((c << 24) & 0xff000000) | ((c << 8) & 0xff0000) | ((c >> 8) & 0xff00) | ((c >> 24) & 0xff);

...
export { test, suite, assert } from "@koalaui/harness"
...
export function assertEqualsBinaryOutput(output: string): void {
    try {
        contextToAbc()
        exec(
            'npm run run:abc',

...
interface SystemTextDecoder {
    decode(input: ArrayBuffer | null | undefined | Uint8Array, options: WithStreamOption | undefined): string;
}
...
export class CustomTextDecoder {
    ...
    decode(input: Uint8Array): string {
        ...
        const cpSize: number = Math.min(CustomTextDecoder.cpArrayMaxSize, input.length);

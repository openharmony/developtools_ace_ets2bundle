...
export interface NormalInterfacePropertyAnnotationInfo extends AnnotationInfo {
    hasBuilder?: boolean;
}

export interface NormalInterfacePropertyAnnotations extends Annotations {
    [DecoratorNames.BUILDER]?: arkts.AnnotationUsage;
}

export class NormalInterfacePropertyAnnotationRecord extends BaseAnnotationRecord<
...
> {
    ...
    updateAnnotationInfoByName(
        info: NormalInterfacePropertyAnnotationInfo,

...
export interface ConditionScopeCollectorOptions extends VisitorOptions {

}

export class ConditionScopeCollector extends AbstractVisitor {
    constructor(options: ConditionScopeCollectorOptions) {
        super(options);
    }
    ...
    visitor(node: arkts.ArrowFunctionExpression): arkts.ArrowFunctionExpression {

...
@Entry() @Component() final class A extends CustomComponent<A, __Options_A> {
...
@Entry({useSharedStorage:false,storage:\"\",routeName:\"\"}) @Component({freezeWhenInactive:false}) final class A extends CustomComponent<A, __Options_A> {
    public __initializeStruct(initializers: __Options_A | undefined, @memo() content: (()=> void) | undefined): void {
        this.__backing_a = new StateDecoratedVariable<string>(\"a\", ((({let gensym___<some_random_number> = initializers;
            (((gensym___<some_random_number>) == (null)) ? undefined : gensym___<some_random_number>.a)})) ?? (\"str\")));
        this.__backing_b = new PropDecoratedVariable<string>(\"b\", (initializers!.b as string));
    }
    public __updateStruct(initializers: __Options_A | undefined): void {
        if (((({let gensym___<some_random_number> = initializers;
            (((gensym___<some_random_number>) == (null)) ? undefined : gensym___<some_random_number>.b)})) !== (undefined))) {
        this.__backing_b!.update((initializers!.b as string));
        }
    }
    private __backing_a?: StateDecoratedVariable<string>;
    public get a(): string {
    ...
    private __backing_b?: PropDecoratedVariable<string>;
    public get b(): string {
...
@Entry({useSharedStorage:false,storage:\"\",routeName:\"\"}) @Component({freezeWhenInactive:false}) export interface __Options_A {
    ...
    set __backing_a(__backing_a: StateDecoratedVariable<string> | undefined)
    get __backing_a(): StateDecoratedVariable<string> | undefined
    set b(b: string | undefined)
    get b(): string | undefined
    set __backing_b(__backing_b: PropDecoratedVariable<string> | undefined)
    get __backing_b(): PropDecoratedVariable<string> | undefined
}

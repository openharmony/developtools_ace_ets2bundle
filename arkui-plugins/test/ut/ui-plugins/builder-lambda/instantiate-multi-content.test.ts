...
// Test multi-content instantiateImpl transformation
function testMultiContent(this: PluginTestContext): void {
...
pluginTester.run(
    'transform $_instantiate for multiple component contents',
    [instantiateTransform],
    {
        'checked:instantiate': [testMultiContent],
    },
    {
        stopAfter: 'checked',
        buildConfig: {
            ...mockBuildConfig(),
            compileFiles: [
                path.resolve(getRootPath(), MOCK_ENTRY_DIR_PATH, 'builder-lambda', 'instantiate-multi-content.ets'),
            ],
            moduleRootPath,
        },
    },

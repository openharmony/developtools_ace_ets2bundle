...
import { Column as Column, ColumnAttribute as ColumnAttribute } from \"@ohos.arkui.component\";
function main() {}
class MyStateSample {
    @memo() public build() {
...
class MyStateSample {
    public build(__memo_context: __memo_context_type, __memo_id: __memo_id_type) {
        ...
        Column(__memo_context, ((__memo_id) + (65509320)), undefined, undefined, ((__memo_context: __memo_context_type, __memo_id: __memo_id_type) => {

...
@Component() final struct IfElse extends CustomComponent<IfElse, __Options_IfElse> {
    ...
    @MemoIntrinsic() public static _invoke(style: @memo() ((instance: IfElse)=> void), initializers: ((()=> __Options_IfElse) | undefined), storage: ((()=> LocalStorage) | undefined), reuseId: (string | undefined), @memo() content: ((()=> void) | undefined)): void {
      CustomComponent._invokeImpl<IfElse, __Options_IfElse>(style, ((): IfElse => {
        return new IfElse(false, ({let gensym___203542966 = storage;
        (((gensym___203542966) == (null)) ? undefined : gensym___203542966())}));
      }), initializers, reuseId, content);
    }
    
    @ComponentBuilder() public static $_invoke(initializers?: __Options_IfElse, storage?: LocalStorage, @Builder() @memo() content?: (()=> void)): IfElse {
...
@Component() final struct IfElse extends CustomComponent<IfElse, __Options_IfElse> {
    ...
    public __updateStruct(initializers: (__Options_IfElse | undefined)): void {}
    @MemoIntrinsic() public static _invoke(__memo_context: __memo_context_type, __memo_id: __memo_id_type, style: @memo() ((__memo_context: __memo_context_type, __memo_id: __memo_id_type, instance: IfElse)=> void), initializers: ((()=> __Options_IfElse) | undefined), storage: ((()=> LocalStorage) | undefined), reuseId: (string | undefined), @memo() content: (((__memo_context: __memo_context_type, __memo_id: __memo_id_type)=> void) | undefined)): void {
      CustomComponent._invokeImpl<IfElse, __Options_IfElse>(__memo_context, ((__memo_id) + (47330804)), style, ((): IfElse => {
        return new IfElse(false, ({let gensym___203542966 = storage;
        (((gensym___203542966) == (null)) ? undefined : gensym___203542966())}));
      }), initializers, reuseId, content);
    }
    
    @ComponentBuilder() public static $_invoke(initializers?: __Options_IfElse, storage?: LocalStorage, @Builder() @memo() content?: ((__memo_context: __memo_context_type, __memo_id: __memo_id_type)=> void)): IfElse {
      throw new Error("Declare interface");
    }

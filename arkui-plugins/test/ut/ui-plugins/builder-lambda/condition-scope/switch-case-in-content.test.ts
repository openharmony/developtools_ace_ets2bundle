            ...
            ConditionScope(@memo() (() => {
                switch (this.num) {
                    ...
                    case \"1\": {
                        ...
                        break;
                        Text(undefined, \"after break\", undefined, undefined);
                    }
                    case \"2\": {
                        ConditionBranch(@memo() (() => {
                    ...
                    default: {
                        ConditionBranch(@memo() (() => {
                            Text(undefined, \"default\", undefined, undefined);
                        }));
                    }
                }
            }));
            ...
            ConditionScope(__memo_context, ((__memo_id) + (<some_random_number>)), @memo() ((__memo_context: __memo_context_type, __memo_id: __memo_id_type) => {
                ...
                switch (this.num) {
                    ...
                    case \"1\": {
                        ...
                        break;
                        Text(__memo_context, ((__memo_id) + (<some_random_number>)), undefined, \"after break\", undefined, undefined);
                    }
                    case \"2\": {
                        ConditionBranch(__memo_context, ((__memo_id) + (<some_random_number>)), @memo() ((__memo_context: __memo_context_type, __memo_id: __memo_id_type) => {
                            const __memo_scope = __memo_context.scope<void>(((__memo_id) + (<some_random_number>)), 0);
                    ...
                    default: {
                        ConditionBranch(__memo_context, ((__memo_id) + (<some_random_number>)), @memo() ((__memo_context: __memo_context_type, __memo_id: __memo_id_type) => {
                            ...
                            Text(__memo_context, ((__memo_id) + (<some_random_number>)), undefined, \"default\", undefined, undefined);
                            {
                                __memo_scope.recache();
                                return;
                            }

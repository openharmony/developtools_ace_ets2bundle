...
const WATCH_DECORATOR_DIR_PATH = "unit/watch_decorator_regular";
const WATCH_DECORATOR_ETS_NAME = "watch_decorator_regular_1";
...
const pluginTester = new PluginTester("watch decorator regular test", buildConfig);

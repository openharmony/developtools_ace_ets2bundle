...
const TEST_SOURCE_FILE_PATH: string = 
    path.resolve(getRootPath(), MOCK_ENTRY_DIR_PATH, INSIGHT_INTENT_DIR_PATH, 'insight-intent-incremental.ets');

const buildConfig: BuildConfig = mockBuildConfig();
buildConfig.compileFiles = [TEST_SOURCE_FILE_PATH];

const pluginTester = new PluginTester('test insight-intent incremental', buildConfig);
  ...
  "extractInsightIntents": [
    {
      ...
      "decoratorClass": "IncrementalTestClass1",
      "intentName": "IncrementalIntent1",
      "domain": "control",
      "intentVersion": "1.0.0",
      "displayName": "IncrementalTest1",
    ...
    },
    {
      ...
      "moduleName": "entry",
      "bundleName": "com.example.mock",
      "decoratorClass": "IncrementalTestClass2",
      "intentName": "IncrementalIntent2",
      "domain": "control",
      "intentVersion": "1.0.0",
      "displayName": "IncrementalTest2",
      "displayDescription": "TestDescription",
      "icon": "$r('app.media.startIcon')",
      "llmDescription": "Description",
      "keywords": [

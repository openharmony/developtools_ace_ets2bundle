...
@Component() final struct PropParent extends CustomComponent<PropParent, __Options_PropParent> {
  public __initializeStruct(initializers: (__Options_PropParent | undefined), @Memo() content: ((()=> void) | undefined)): void {
    ...
    this.__backing_propVar2 = STATE_MGMT_FACTORY.makePropRef<(number | undefined)>(this, "propVar2", (({let gensym___<some_random_number> = initializers;
    ...
    this.__backing_propVar6 = STATE_MGMT_FACTORY.makePropRef<(Array<number> | null)>(this, "propVar6", (({let gensym___<some_random_number> = initializers;
    ...
    this.__backing_propVar7 = STATE_MGMT_FACTORY.makePropRef<(Map<string, number> | undefined)>(this, "propVar7", (({let gensym___<some_random_number> = initializers;

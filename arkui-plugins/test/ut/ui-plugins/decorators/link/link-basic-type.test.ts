...
interface __Options_LinkParent {
  ...
  abstract set __backing_linkVar1(__backing_linkVar1: DecoratedV1VariableBase<string> | undefined)
  abstract get __backing_linkVar1(): DecoratedV1VariableBase<string> | undefined
  abstract set linkVar2(linkVar2: number | undefined)
  abstract get linkVar2(): number | undefined
  abstract set __backing_linkVar2(__backing_linkVar2: DecoratedV1VariableBase<number> | undefined)
  abstract get __backing_linkVar2(): DecoratedV1VariableBase<number> | undefined
  abstract set linkVar3(linkVar3: boolean | undefined)
  abstract get linkVar3(): boolean | undefined
  abstract set __backing_linkVar3(__backing_linkVar3: DecoratedV1VariableBase<boolean> | undefined)
  abstract get __backing_linkVar3(): DecoratedV1VariableBase<boolean> | undefined
  abstract set linkVar4(linkVar4: undefined | undefined)
  abstract get linkVar4(): undefined | undefined
  abstract set __backing_linkVar4(__backing_linkVar4: DecoratedV1VariableBase<undefined> | undefined)
  abstract get __backing_linkVar4(): DecoratedV1VariableBase<undefined> | undefined
  abstract set linkVar5(linkVar5: null | undefined)
  abstract get linkVar5(): null | undefined
  abstract set __backing_linkVar5(__backing_linkVar5: DecoratedV1VariableBase<null> | undefined)
  abstract get __backing_linkVar5(): DecoratedV1VariableBase<null> | undefined
}
`;

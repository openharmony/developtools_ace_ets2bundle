...
interface __Options_Parent {
  abstract set linkVar1(linkVar1: Per | undefined)
  abstract get linkVar1(): Per | undefined
  abstract set __backing_linkVar1(__backing_linkVar1: DecoratedV1VariableBase<Per> | undefined)
  abstract get __backing_linkVar1(): DecoratedV1VariableBase<Per> | undefined
  abstract set linkVar2(linkVar2: Array<number> | undefined)
  abstract get linkVar2(): Array<number> | undefined
  abstract set __backing_linkVar2(__backing_linkVar2: DecoratedV1VariableBase<Array<number>> | undefined)
  abstract get __backing_linkVar2(): DecoratedV1VariableBase<Array<number>> | undefined
  abstract set linkVar3(linkVar3: LinkType | undefined)
  abstract get linkVar3(): LinkType | undefined
  abstract set __backing_linkVar3(__backing_linkVar3: DecoratedV1VariableBase<LinkType> | undefined)
  abstract get __backing_linkVar3(): DecoratedV1VariableBase<LinkType> | undefined
  abstract set linkVar4(linkVar4: Set<string> | undefined)
  abstract get linkVar4(): Set<string> | undefined
  abstract set __backing_linkVar4(__backing_linkVar4: DecoratedV1VariableBase<Set<string>> | undefined)
  abstract get __backing_linkVar4(): DecoratedV1VariableBase<Set<string>> | undefined
  abstract set linkVar5(linkVar5: Array<boolean> | undefined)
  abstract get linkVar5(): Array<boolean> | undefined
  abstract set __backing_linkVar5(__backing_linkVar5: DecoratedV1VariableBase<Array<boolean>> | undefined)
  abstract get __backing_linkVar5(): DecoratedV1VariableBase<Array<boolean>> | undefined
  abstract set linkVar6(linkVar6: Array<Per> | undefined)
  abstract get linkVar6(): Array<Per> | undefined
  abstract set __backing_linkVar6(__backing_linkVar6: DecoratedV1VariableBase<Array<Per>> | undefined)
  abstract get __backing_linkVar6(): DecoratedV1VariableBase<Array<Per>> | undefined
  abstract set linkVar7(linkVar7: Array<Per> | undefined)
  abstract get linkVar7(): Array<Per> | undefined
  abstract set __backing_linkVar7(__backing_linkVar7: DecoratedV1VariableBase<Array<Per>> | undefined)
  abstract get __backing_linkVar7(): DecoratedV1VariableBase<Array<Per>> | undefined
  abstract set linkVar8(linkVar8: ((sr: string)=> void) | undefined)
  abstract get linkVar8(): ((sr: string)=> void) | undefined
  abstract set __backing_linkVar8(__backing_linkVar8: DecoratedV1VariableBase<((sr: string)=> void)> | undefined)
  abstract get __backing_linkVar8(): DecoratedV1VariableBase<((sr: string)=> void)> | undefined
  abstract set linkVar9(linkVar9: Date | undefined)
  abstract get linkVar9(): Date | undefined
  abstract set __backing_linkVar9(__backing_linkVar9: DecoratedV1VariableBase<Date> | undefined)
  abstract get __backing_linkVar9(): DecoratedV1VariableBase<Date> | undefined
  abstract set linkVar10(linkVar10: Map<number, Per> | undefined)
  abstract get linkVar10(): Map<number, Per> | undefined
  abstract set __backing_linkVar10(__backing_linkVar10: DecoratedV1VariableBase<Map<number, Per>> | undefined)
  abstract get __backing_linkVar10(): DecoratedV1VariableBase<Map<number, Per>> | undefined
  abstract set linkVar11(linkVar11: string | number | undefined)
  abstract get linkVar11(): string | number | undefined
  abstract set __backing_linkVar11(__backing_linkVar11: DecoratedV1VariableBase<string | number> | undefined)
  abstract get __backing_linkVar11(): DecoratedV1VariableBase<string | number> | undefined
  abstract set linkVar12(linkVar12: Set<string> | Per | undefined)
  abstract get linkVar12(): Set<string> | Per | undefined
  abstract set __backing_linkVar12(__backing_linkVar12: DecoratedV1VariableBase<Set<string> | Per> | undefined)
  abstract get __backing_linkVar12(): DecoratedV1VariableBase<Set<string> | Per> | undefined
}
`;

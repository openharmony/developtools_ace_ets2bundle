...
interface __Options_Parent {
  ...
  get __backing_propVar1(): PropDecoratedVariable<Per> | undefined
  set propVar2(propVar2: Array<number> | undefined)
  get propVar2(): Array<number> | undefined
  set __backing_propVar2(__backing_propVar2: PropDecoratedVariable<Array<number>> | undefined)
  get __backing_propVar2(): PropDecoratedVariable<Array<number>> | undefined
  set propVar3(propVar3: PropType | undefined)
  get propVar3(): PropType | undefined
  set __backing_propVar3(__backing_propVar3: PropDecoratedVariable<PropType> | undefined)
  get __backing_propVar3(): PropDecoratedVariable<PropType> | undefined
  set propVar4(propVar4: Set<string> | undefined)
  get propVar4(): Set<string> | undefined
  set __backing_propVar4(__backing_propVar4: PropDecoratedVariable<Set<string>> | undefined)
  get __backing_propVar4(): PropDecoratedVariable<Set<string>> | undefined
  set propVar5(propVar5: Array<boolean> | undefined)
  get propVar5(): Array<boolean> | undefined
  set __backing_propVar5(__backing_propVar5: PropDecoratedVariable<Array<boolean>> | undefined)
  get __backing_propVar5(): PropDecoratedVariable<Array<boolean>> | undefined
  set propVar6(propVar6: Array<Per> | undefined)
  get propVar6(): Array<Per> | undefined
  set __backing_propVar6(__backing_propVar6: PropDecoratedVariable<Array<Per>> | undefined)
  get __backing_propVar6(): PropDecoratedVariable<Array<Per>> | undefined
  set propVar7(propVar7: Array<Per> | undefined)
  get propVar7(): Array<Per> | undefined
  set __backing_propVar7(__backing_propVar7: PropDecoratedVariable<Array<Per>> | undefined)
  get __backing_propVar7(): PropDecoratedVariable<Array<Per>> | undefined
  set propVar8(propVar8: ((sr: string)=> void) | undefined)
  get propVar8(): ((sr: string)=> void) | undefined
  set __backing_propVar8(__backing_propVar8: PropDecoratedVariable<((sr: string)=> void)> | undefined)
  get __backing_propVar8(): PropDecoratedVariable<((sr: string)=> void)> | undefined
  set propVar9(propVar9: Date | undefined)
  get propVar9(): Date | undefined
  set __backing_propVar9(__backing_propVar9: PropDecoratedVariable<Date> | undefined)
  get __backing_propVar9(): PropDecoratedVariable<Date> | undefined
  set propVar10(propVar10: Map<number, Per> | undefined)
  get propVar10(): Map<number, Per> | undefined
  set __backing_propVar10(__backing_propVar10: PropDecoratedVariable<Map<number, Per>> | undefined)

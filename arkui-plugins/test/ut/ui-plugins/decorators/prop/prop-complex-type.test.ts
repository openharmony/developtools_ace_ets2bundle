...
buildConfig.compileFiles = [
    path.resolve(getRootPath(), MOCK_ENTRY_DIR_PATH, BUILDER_LAMBDA_DIR_PATH, 'prop-complex-type.ets'),
];

const pluginTester = new PluginTester('test complex type @Prop decorated variables transformation', buildConfig);

const parsedTransform: Plugins = {
    name: 'prop-complex-type',
...
@Component() final struct Parent extends CustomComponent<Parent, __Options_Parent> {
  public __initializeStruct(initializers: (__Options_Parent | undefined), @memo() content: ((()=> void) | undefined)): void {
    ...
    this.__backing_propVar3 = STATE_MGMT_FACTORY.makeProp<PropType>(this, "propVar3", ((({let gensym___201781257 = initializers;
    (((gensym___201781257) == (null)) ? undefined : gensym___201781257.propVar3)})) ?? (PropType.TYPE3)));
    this.__backing_propVar4 = STATE_MGMT_FACTORY.makeProp<Set<string>>(this, "propVar4", ((({let gensym___22028950 = initializers;
    (((gensym___22028950) == (null)) ? undefined : gensym___22028950.propVar4)})) ?? (new Set<string>(new Array<string>("aa", "bb")))));
    this.__backing_propVar5 = STATE_MGMT_FACTORY.makeProp<Array<boolean>>(this, "propVar5", ((({let gensym___54872258 = initializers;
    (((gensym___54872258) == (null)) ? undefined : gensym___54872258.propVar5)})) ?? ([true, false])));
    this.__backing_propVar6 = STATE_MGMT_FACTORY.makeProp<Array<Per>>(this, "propVar6", ((({let gensym___128760941 = initializers;
    (((gensym___128760941) == (null)) ? undefined : gensym___128760941.propVar6)})) ?? (new Array<Per>(new Per(7), new Per(11)))));
    this.__backing_propVar7 = STATE_MGMT_FACTORY.makeProp<Array<Per>>(this, "propVar7", ((({let gensym___30534085 = initializers;
    (((gensym___30534085) == (null)) ? undefined : gensym___30534085.propVar7)})) ?? ([new Per(7), new Per(11)])));
    this.__backing_propVar8 = STATE_MGMT_FACTORY.makeProp<((sr: string)=> void)>(this, "propVar8", ((({let gensym___12471776 = initializers;
    (((gensym___12471776) == (null)) ? undefined : gensym___12471776.propVar8)})) ?? (((sr: string) => {}))));
    this.__backing_propVar9 = STATE_MGMT_FACTORY.makeProp<Date>(this, "propVar9", ((({let gensym___123472108 = initializers;
  ...
  private __backing_propVar1?: IPropDecoratedVariable<Per>;
  ...
  private __backing_propVar2?: IPropDecoratedVariable<Array<number>>;
  ...
  private __backing_propVar3?: IPropDecoratedVariable<PropType>;
  ...
  private __backing_propVar4?: IPropDecoratedVariable<Set<string>>;
  ...
  private __backing_propVar5?: IPropDecoratedVariable<Array<boolean>>;
  ...
  private __backing_propVar6?: IPropDecoratedVariable<Array<Per>>;
  ...
  private __backing_propVar7?: IPropDecoratedVariable<Array<Per>>;
  ...
  private __backing_propVar8?: IPropDecoratedVariable<((sr: string)=> void)>;
  ...
  private __backing_propVar9?: IPropDecoratedVariable<Date>;
  ...
  private __backing_propVar10?: IPropDecoratedVariable<Map<number, Per>>;

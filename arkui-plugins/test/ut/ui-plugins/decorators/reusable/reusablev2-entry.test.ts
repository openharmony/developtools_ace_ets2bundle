...
buildConfig.compileFiles = [
    path.resolve(getRootPath(), MOCK_ENTRY_DIR_PATH, REUSABLE_DIR_PATH, 'reusablev2-entry.ets'),
];
...
const pluginTester = new PluginTester('test struct decorated with both entry and reusablev2', buildConfig);
...
import { Column as Column, ComponentV2 as ComponentV2, Entry as Entry, ReusableV2 as ReusableV2 } from "@ohos.arkui.component";
...
__EntryWrapper.RegisterNamedRouter("", new __EntryWrapper(), ({
  ...
  moduleName: "entry",
  pagePath: "../../../decorators/reusable/reusablev2-entry",
  pageFullPath: "test/demo/mock/decorators/reusable/reusablev2-entry",
  integratedHsp: "false",
} as NavInterface));
@Entry({useSharedStorage:false,storage:"",routeName:""}) @ComponentV2({poolAccepts:[],reusePool:ReusePoolOwnership.OFF}) @ReusableV2() final struct Index extends CustomComponentV2<Index, __Options_Index> implements PageLifeCycle {
...
@Entry({useSharedStorage:false,storage:"",routeName:""}) @ComponentV2({poolAccepts:[],reusePool:ReusePoolOwnership.OFF}) @ReusableV2() interface __Options_Index {
...
pluginTester.run(
    'test struct decorated with both entry and reusablev2',

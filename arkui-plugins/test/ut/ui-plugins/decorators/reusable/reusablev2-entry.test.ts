...
@Entry({useSharedStorage:false,storage:"",routeName:""}) @ComponentV2() @ReusableV2() final struct Index extends CustomComponentV2<Index, __Options_Index> implements PageLifeCycle {
...
@Entry({useSharedStorage:false,storage:"",routeName:""}) @ComponentV2() @ReusableV2() export interface __Options_Index {

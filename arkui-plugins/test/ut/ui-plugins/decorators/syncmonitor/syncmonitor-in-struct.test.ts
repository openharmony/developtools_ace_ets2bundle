...
buildConfig.compileFiles = [
    path.resolve(getRootPath(), MOCK_ENTRY_DIR_PATH, STATE_DIR_PATH, 'syncmonitor-in-struct.ets'),
];

const pluginTester = new PluginTester('test @SyncMonitor decorator in struct transformation', buildConfig);
...
__EntryWrapper.RegisterNamedRouter("", new __EntryWrapper(), ({
  ...
  moduleName: "entry",
  pagePath: "../../../decorators/syncmonitor/syncmonitor-in-struct",
  pageFullPath: "test/demo/mock/decorators/syncmonitor/syncmonitor-in-struct",
  integratedHsp: "false",
} as NavInterface));
...
pluginTester.run(
    'test @SyncMonitor decorator in struct transformation',

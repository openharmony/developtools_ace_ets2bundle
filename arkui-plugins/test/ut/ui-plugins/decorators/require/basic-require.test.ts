...
@Component() export interface __Options_MyStateSample {
  ...
  ${dumpGetterSetter(GetSetDumper.BOTH, 'select100', '(string | undefined)', [dumpAnnotation('Require')])}
  ${dumpGetterSetter(GetSetDumper.BOTH, '__options_has_select100', '(boolean | undefined)')}

  ${dumpGetterSetter(GetSetDumper.BOTH, 'select0', '(number | undefined)', [dumpAnnotation('State'), dumpAnnotation('Require')])}
  ...
  ${dumpGetterSetter(GetSetDumper.BOTH, 'select3', '((number | null) | undefined)', [dumpAnnotation('State'), dumpAnnotation('Require')])}
  ...
  ${dumpGetterSetter(GetSetDumper.BOTH, 'select4', '(undefined | undefined)', [dumpAnnotation('State'), dumpAnnotation('Require')])}
  ...
  ${dumpGetterSetter(GetSetDumper.BOTH, 'select1', '(string | undefined)', [dumpAnnotation('PropRef'), dumpAnnotation('Require')])}
  ...
  ${dumpGetterSetter(GetSetDumper.BOTH, 'select2', '(Array<string> | undefined)', [dumpAnnotation('Provide', { alias: "15", allowOverride: false }), dumpAnnotation('Require')])}
  ...
  ${dumpGetterSetter(GetSetDumper.BOTH, 'select6', '((Array<string> | undefined | string) | undefined)', [dumpAnnotation('Provide', { alias: "t", allowOverride: false }), dumpAnnotation('Require')])}
  ...
  ${dumpGetterSetter(GetSetDumper.BOTH, 'builder', '(@Memo() (()=> void) | undefined)', [dumpAnnotation('Require')])}
  ${dumpGetterSetter(GetSetDumper.BOTH, '__options_has_builder', '(boolean | undefined)')}
  
}

@ComponentV2() export interface __Options_V2222 {
  ${dumpGetterSetter(GetSetDumper.BOTH, 'select1', '(string | undefined)', [dumpAnnotation('Param'), dumpAnnotation('Require')])}

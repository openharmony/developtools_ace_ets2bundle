...
@Component() final struct PropParent extends CustomComponent<PropParent, __Options_PropParent> {
  public __initializeStruct(initializers: (__Options_PropParent | undefined), @Memo() content: ((()=> void) | undefined)): void {
    this.__backing_provideVar1 = STATE_MGMT_FACTORY.makeProvide<string>(this, "provideVar1", "provideVar1", (({let gensym___<some_random_number> = initializers;
    (((gensym___<some_random_number>) == (null)) ? undefined : gensym___<some_random_number>.__options_has_provideVar1)}) ? (initializers!.provideVar1 as string) : ("propVar1" as string)), false);
    this.__backing_provideVar2 = STATE_MGMT_FACTORY.makeProvide<number>(this, "provideVar2", "provideVar2", (({let gensym___<some_random_number> = initializers;
    (((gensym___<some_random_number>) == (null)) ? undefined : gensym___<some_random_number>.__options_has_provideVar2)}) ? (initializers!.provideVar2 as number) : (50 as number)), false);
    this.__backing_provideVar3 = STATE_MGMT_FACTORY.makeProvide<boolean>(this, "provideVar3", "provideVar3", (({let gensym___<some_random_number> = initializers;
    (((gensym___<some_random_number>) == (null)) ? undefined : gensym___<some_random_number>.__options_has_provideVar3)}) ? (initializers!.provideVar3 as boolean) : (true as boolean)), false);
    this.__backing_provideVar4 = STATE_MGMT_FACTORY.makeProvide<undefined>(this, "provideVar4", "provideVar4", (({let gensym___<some_random_number> = initializers;
    (((gensym___<some_random_number>) == (null)) ? undefined : gensym___<some_random_number>.__options_has_provideVar4)}) ? (initializers!.provideVar4 as undefined) : undefined), false);
    this.__backing_provideVar5 = STATE_MGMT_FACTORY.makeProvide<null>(this, "provideVar5", "provideVar5", (({let gensym___<some_random_number> = initializers;
    (((gensym___<some_random_number>) == (null)) ? undefined : gensym___<some_random_number>.__options_has_provideVar5)}) ? (initializers!.provideVar5 as null) : null), false);
    ...
    (((gensym___<some_random_number>) == (null)) ? undefined : gensym___<some_random_number>.__options_has_provideVar6)}) ? (initializers!.provideVar6 as (string | undefined)) : ("hello" as (string | undefined))), false);
    ...
    (((gensym___<some_random_number>) == (null)) ? undefined : gensym___<some_random_number>.__options_has_provideVar7)}) ? (initializers!.provideVar7 as (string | null)) : null), false);
    ...
    (((gensym___<some_random_number>) == (null)) ? undefined : gensym___<some_random_number>.__options_has_provideVar8)}) ? (initializers!.provideVar8 as number) : (10 as number)), false);
    ...
    (((gensym___<some_random_number>) == (null)) ? undefined : gensym___<some_random_number>.__options_has_provideVar9)}) ? (initializers!.provideVar9 as (string | undefined)) : ("hello" as (string | undefined))), false);
    ...
    (((gensym___<some_random_number>) == (null)) ? undefined : gensym___<some_random_number>.__options_has_provideVar10)}) ? (initializers!.provideVar10 as number) : (10 as number)), true);
    ...
    (((gensym___<some_random_number>) == (null)) ? undefined : gensym___<some_random_number>.__options_has_provideVar11)}) ? (initializers!.provideVar11 as (string | undefined)) : undefined), true);
    ...
    (((gensym___<some_random_number>) == (null)) ? undefined : gensym___<some_random_number>.__options_has_provideVar12)}) ? (initializers!.provideVar12 as number) : (15 as number)), false);
    ...
    (((gensym___<some_random_number>) == (null)) ? undefined : gensym___<some_random_number>.__options_has_provideVar13)}) ? (initializers!.provideVar13 as (string | undefined)) : ("prop13" as (string | undefined))), false);
    ...
    (((gensym___<some_random_number>) == (null)) ? undefined : gensym___<some_random_number>.__options_has_provideVar14)}) ? (initializers!.provideVar14 as (boolean | undefined)) : (false as (boolean | undefined))), true);
    ...
    (((gensym___<some_random_number>) == (null)) ? undefined : gensym___<some_random_number>.__options_has_provideVar15)}) ? (initializers!.provideVar15 as (string | undefined)) : undefined), true);
    ...
    (((gensym___<some_random_number>) == (null)) ? undefined : gensym___<some_random_number>.__options_has_provideVar16)}) ? (initializers!.provideVar16 as (number | undefined)) : (20 as (number | undefined))), false);
    ...
    (((gensym___<some_random_number>) == (null)) ? undefined : gensym___<some_random_number>.__options_has_provideVar17)}) ? (initializers!.provideVar17 as (boolean | undefined)) : (true as (boolean | undefined))), false);
  }

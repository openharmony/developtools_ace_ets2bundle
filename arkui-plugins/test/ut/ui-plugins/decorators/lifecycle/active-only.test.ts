...
buildConfig.compileFiles = [
    path.resolve(getRootPath(), MOCK_ENTRY_DIR_PATH, BUILDER_LAMBDA_DIR_PATH, 'active-only.ets'),
];

const pluginTester = new PluginTester('test @ComponentActive only decorator transformation', buildConfig);
...
import { ComponentActive as ComponentActive } from "@kit.ArkUI";
...
__EntryWrapper.RegisterNamedRouter("", new __EntryWrapper(), ({
  ...
  moduleName: "entry",
  pagePath: "../../../decorators/lifecycle/active-only",
  pageFullPath: "test/demo/mock/decorators/lifecycle/active-only",
  integratedHsp: "false",
} as NavInterface));
...
pluginTester.run(
    'test @ComponentActive only decorator transformation',

...
buildConfig.compileFiles = [
    path.resolve(getRootPath(), MOCK_ENTRY_DIR_PATH, DECL_DIR_PATH, 'struct-entry-body-usage.ets'),
];

const pluginTester = new PluginTester('test declarations in @Entry struct with body', buildConfig);
...
import { ExportEntryStructWithBody as ExportEntryStructWithBody } from "./utils/struct-entry-body";
...
function aBuilder(): void {
  ExportEntryStructWithBody._invoke(undefined, undefined, undefined, undefined, undefined);
}

__EntryWrapper.RegisterNamedRouter("", new __EntryWrapper(), ({
  bundleName: "com.example.mock",
  moduleName: "entry",
  pagePath: "../../../declarations/struct-entry-body-usage",
  pageFullPath: "test/demo/mock/declarations/struct-entry-body-usage",
  integratedHsp: "false",
} as NavInterface));
...
@Entry() @Component() export final struct ExportEntryStructWithBody extends CustomComponent<ExportEntryStructWithBody, __Options_ExportEntryStructWithBody> implements PageLifeCycle {
  @ComponentBuilder() 
  ...
  public static _buildCompatibleNode(options: __Options_ExportEntryStructWithBody): void
...
@Entry() @Component() export declare class __Options_ExportEntryStructWithBody {
  public constructor()
...
function testUITransformer(this: PluginTestContext): void {
    ...
    const declarationScript = this.declContexts?.['mock.demo.mock.declarations.utils.struct-entry-body']?.scriptSnapshot ?? '';
...
function aBuilder(__memo_context: __memo_context_type, __memo_id: __memo_id_type): void {
  ...
  ExportEntryStructWithBody._invoke(__memo_context, ((__memo_id) + (47330804)), undefined, undefined, undefined, undefined, undefined);
  {
...
@Entry() @Component() final struct MyStateSample extends CustomComponent<MyStateSample, __Options_MyStateSample> implements PageLifeCycle {
  ...
  public build(__memo_context: __memo_context_type, __memo_id: __memo_id_type) {
    ...
    ColumnImpl(__memo_context, ((__memo_id) + (46726221)), @Memo() ((__memo_context: __memo_context_type, __memo_id: __memo_id_type, instance: ColumnAttribute): void => {
      ...
      ExportEntryStructWithBody._invoke(__memo_context, ((__memo_id) + (211301233)), undefined, undefined, undefined, undefined, undefined);
      {
        __memo_scope.recache();
        return;
      }
...
pluginTester.run(
    'test declarations in @Entry struct with body',
    ...
    {
        stopAfter: 'checked',
        tracing: { externalSourceNames: ['mock.demo.mock.declarations.utils.struct-entry-body'] }
    }
);

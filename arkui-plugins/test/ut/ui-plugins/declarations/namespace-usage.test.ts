...
buildConfig.compileFiles = [
    path.resolve(getRootPath(), MOCK_ENTRY_DIR_PATH, DECL_DIR_PATH, 'namespace-usage.ets'),
];

const pluginTester = new PluginTester('test declarations in namespace', buildConfig);
...
import aNamespace from "./utils/namespace";
...
const ExportObservedWithBodyVar = new aNamespace.ExportObservedWithBody();
const ExportObservedImplWithBodyVar = new aNamespace.ExportObservedImplWithBody();
const ExportObservedWithTrackWithBodyVar = new aNamespace.ExportObservedWithTrackWithBody();
const ExportTrackWithoutObservedWithBodyVar = new aNamespace.ExportTrackWithoutObservedWithBody();
const SomeObV2ClassVar = new SomeObV2Class(1);
const SomeObV2ClassImplVar = new SomeObV2ClassImpl(2);
const ExportObservedV2WithBodyVar = new aNamespace.ExportObservedV2WithBody(1);
const ExportObservedV2InheritWithBodyVar = new aNamespace.ExportObservedV2InheritWithBody(2);
function main() {}
...
function ConstantBuilder(): void {
  TextImpl(@Memo() ((instance: TextAttribute): void => {
    instance.setTextOptions(aNamespace.EXPORT_RESOURCE, undefined);
    instance.applyAttributesFinish();
    return;
  }), undefined);
  aNamespace.EXPORT_WRAPPED_BUILDER.builder("name", 1);
}

@Builder() 
@Memo() 
function aBuilder(): void {
  aNamespace.ExportCustomDialogWithBody._invoke((() => {
    return {
      controller: null,
      __options_has_controller: true,
    };
  }), undefined, undefined, undefined);
  aNamespace.ExportEntryStruct._invoke(undefined, undefined, undefined, undefined, undefined);
  aNamespace.ExportStructV1._invoke(undefined, undefined, undefined, undefined, undefined);
}

@Builder() 
@Memo() 
function aBuilder1(@MemoSkip() someRequiredParam: number): void {
  aNamespace.ExportStructV2WithBody._invoke(undefined, (() => {
    return {
...
function mockFunction(obj: aNamespace.IBuilderInArgs): void {
  obj.mockBuilderMethod1((() => {}));
  obj.mockBuilderMethod2((() => {}));
}

aNamespace.EXPORT_RAWFILE = _rawfile(0, 30000, "com.example.mock", "entry", "app.mock.txt");
__EntryWrapper.RegisterNamedRouter("", new __EntryWrapper(), ({
  bundleName: "com.example.mock",
  moduleName: "entry",
  pagePath: "../../../declarations/namespace-usage",
  pageFullPath: "test/demo/mock/declarations/namespace-usage",
  integratedHsp: "false",
} as NavInterface));
class SomeObClass extends aNamespace.ExportObserved implements aNamespace.IO {
...
class SomeObClassImpl extends aNamespace.ExportObservedImpl {
  public someMethod(): void {
    console.log(this.t1);
  }
...
class SomeObClassWithTrack extends aNamespace.ExportObservedWithTrack {
  public t1: number = 1;
...
class SomeTrClassInherit extends aNamespace.ExportTrackWithoutObserved {
  public constructor() {}
  
}

class SomeObV2Class extends aNamespace.ExportObservedV2 implements aNamespace.IO {
  public someMethod(): void {
    console.log(this.t1);
  }
...
class SomeObV2ClassImpl extends aNamespace.ExportObservedV2Inherit {
  public someMethod(): void {
    console.log(this.t1);
  }
...
@Component() final struct ConstantStruct extends CustomComponent<ConstantStruct, __Options_ConstantStruct> {
  public __initializeStruct(initializers: (__Options_ConstantStruct | undefined), @Memo() content: ((()=> void) | undefined)): void {
    ...
    (((gensym___115611008) == (null)) ? undefined : gensym___115611008.stateVar)})) ?? (aNamespace.EXPORT_RESOURCE)));
  }
  ...
  public resetStateVarsOnReuse(initializers: (__Options_ConstantStruct | undefined)): void {
    ...
    (((gensym___45886084) == (null)) ? undefined : gensym___45886084.stateVar)})) ?? (aNamespace.EXPORT_RESOURCE)));
  }
...
@Component() final struct DialogStruct extends CustomComponent<DialogStruct, __Options_DialogStruct> {
  public __initializeStruct(initializers: (__Options_DialogStruct | undefined), @Memo() content: ((()=> void) | undefined)): void {
    ...
    gensym___192738000 = new CustomDialogController({
      builder: @Memo() (() => {
        aNamespace.ExportCustomDialog._invoke((() => {
          return {
...
@Entry() @Component() final struct EntryStruct extends CustomComponent<EntryStruct, __Options_EntryStruct> implements PageLifeCycle {
  public __initializeStruct(initializers: (__Options_EntryStruct | undefined), @Memo() content: ((()=> void) | undefined)): void {}
  
  public __updateStruct(initializers: (__Options_EntryStruct | undefined)): void {}
  
  public resetStateVarsOnReuse(initializers: (__Options_EntryStruct | undefined)): void {}
  
  @MemoIntrinsic() 
  public static _invoke(style: (@Memo() ((instance: EntryStruct)=> void) | undefined), initializers: ((()=> __Options_EntryStruct) | undefined), storage: ((()=> LocalStorage) | undefined), reuseId: (string | undefined), @Memo() content: ((()=> void) | undefined)): void {
    CustomComponent._invokeImpl<EntryStruct, __Options_EntryStruct>(style, ((): EntryStruct => {
      return new EntryStruct(false, ({let gensym___29142858 = storage;
      (((gensym___29142858) == (null)) ? undefined : gensym___29142858())}));
    }), initializers, reuseId, content);
  }
  
  @ComponentBuilder() 
  public static $_invoke(initializers?: __Options_EntryStruct, storage?: LocalStorage, @Builder() @Memo() content?: (()=> void)): EntryStruct {
    throw new Error("Declare interface");
  }
...
@Component() final struct V1Struct extends CustomComponent<V1Struct, __Options_V1Struct> {
  ...
  public build() {
    ColumnImpl(@Memo() ((instance: ColumnAttribute): void => {
      ...
      aNamespace.ExportStructV1._invoke(undefined, undefined, undefined, undefined, undefined);
      aNamespace.ExportStructV1WithBody._invoke(undefined, (() => {
        return {
          __backing_someLink: this.__backing_aNumber,
          __options_has_someLink: true,
        };
...
@ComponentV2() final struct V2Struct extends CustomComponentV2<V2Struct, __Options_V2Struct> {
  ...
  public build() {
    ColumnImpl(@Memo() ((instance: ColumnAttribute): void => {
      ...
      aNamespace.ExportStructV2._invoke(undefined, undefined, undefined, undefined, undefined);
      aNamespace.ExportStructV2WithBody._invoke(undefined, (() => {
        return {
...
class __EntryWrapper extends EntryPoint {
  @Memo() 
  public entry(): void {
    EntryStruct._invoke(undefined, undefined, undefined, undefined, undefined);
  }
...
@Entry() @Component() class __Options_EntryStruct {
  public constructor() {}
...
import { CustomDialog, Component, ComponentV2, Entry, BuilderParam, Column, CustomDialogController, Resource, WrappedBuilder, Builder, $r, $rawfile, Resource, AnimatableExtend, TextAttribute } from "@ohos.arkui.component";

import { Observed, ObservedV2, Track, Trace, Monitor, Computed, State, Link, Local, Param, Require } from "@ohos.arkui.stateManagement";


export default declare namespace aNamespace {
  ...
  @Entry() @Component() final struct ExportEntryStruct extends CustomComponent<ExportEntryStruct, __Options_ExportEntryStruct> implements PageLifeCycle {
    @ComponentBuilder() 
  ...
  @Entry() @Component() class __Options_ExportEntryStruct {
    public constructor()
...
function testUITransformer(this: PluginTestContext): void {
    ...
    const declarationScript = this.declContexts?.['mock.demo.mock.declarations.utils.namespace']?.scriptSnapshot ?? '';
...
function ConstantBuilder(__memo_context: __memo_context_type, __memo_id: __memo_id_type): void {
  ...
  TextImpl(__memo_context, ((__memo_id) + (175145513)), @Memo() ((__memo_context: __memo_context_type, __memo_id: __memo_id_type, instance: TextAttribute): void => {
    ...
    __memo_parameter_instance.value.setTextOptions(aNamespace.EXPORT_RESOURCE, undefined);
  ...
  aNamespace.EXPORT_WRAPPED_BUILDER.builder(__memo_context, ((__memo_id) + (241913892)), "name", 1);
  {
    __memo_scope.recache();
    return;
  }
...
function aBuilder(__memo_context: __memo_context_type, __memo_id: __memo_id_type): void {
  ...
  aNamespace.ExportCustomDialogWithBody._invoke(__memo_context, ((__memo_id) + (211301233)), (() => {
    return {
      controller: null,
      __options_has_controller: true,
    };
  }), undefined, undefined, undefined);
  aNamespace.ExportEntryStruct._invoke(__memo_context, ((__memo_id) + (213104625)), undefined, undefined, undefined, undefined, undefined);
  aNamespace.ExportStructV1._invoke(__memo_context, ((__memo_id) + (46726221)), undefined, undefined, undefined, undefined, undefined);
  {
    __memo_scope.recache();
    return;
  }
...
function aBuilder1(__memo_context: __memo_context_type, __memo_id: __memo_id_type, @MemoSkip() someRequiredParam: number): void {
  ...
  aNamespace.ExportStructV2WithBody._invoke(__memo_context, ((__memo_id) + (218979098)), undefined, (() => {
    return {
      someRequiredParam: someRequiredParam,
      __options_has_someRequiredParam: true,
    };
...
@Component() final struct DialogStruct extends CustomComponent<DialogStruct, __Options_DialogStruct> {
  public __initializeStruct(initializers: (__Options_DialogStruct | undefined), @Memo() content: (((__memo_context: __memo_context_type, __memo_id: __memo_id_type)=> void) | undefined)): void {
    ...
    gensym___192738000 = new CustomDialogController({
      builder: @Memo() ((__memo_context: __memo_context_type, __memo_id: __memo_id_type) => {
        ...
        aNamespace.ExportCustomDialog._invoke(__memo_context, ((__memo_id) + (78055758)), (() => {
          return {
            __backing_someLink: this.__backing_aNumber,
            __options_has_someLink: true,
          };
  ...
  public build(__memo_context: __memo_context_type, __memo_id: __memo_id_type) {
    ...
    ColumnImpl(__memo_context, ((__memo_id) + (75321118)), @Memo() ((__memo_context: __memo_context_type, __memo_id: __memo_id_type, instance: ColumnAttribute): void => {
      ...
      aNamespace.ExportCustomDialog._invoke(__memo_context, ((__memo_id) + (151409217)), (() => {
        return {
          __backing_someLink: this.__backing_aNumber,
          __options_has_someLink: true,
        };
      }), undefined, undefined, undefined);
      aNamespace.ExportCustomDialogWithBody._invoke(__memo_context, ((__memo_id) + (238360624)), (() => {
        return {
          controller: this.controller,
          __options_has_controller: true,
        };
...
@Entry() @Component() final struct EntryStruct extends CustomComponent<EntryStruct, __Options_EntryStruct> implements PageLifeCycle {
  public __initializeStruct(initializers: (__Options_EntryStruct | undefined), @Memo() content: (((__memo_context: __memo_context_type, __memo_id: __memo_id_type)=> void) | undefined)): void {}
  ...
  @MemoIntrinsic() 
  public static _invoke(__memo_context: __memo_context_type, __memo_id: __memo_id_type, style: (@Memo() ((__memo_context: __memo_context_type, __memo_id: __memo_id_type, instance: EntryStruct)=> void) | undefined), initializers: ((()=> __Options_EntryStruct) | undefined), storage: ((()=> LocalStorage) | undefined), reuseId: (string | undefined), @Memo() content: (((__memo_context: __memo_context_type, __memo_id: __memo_id_type)=> void) | undefined)): void {
    CustomComponent._invokeImpl<EntryStruct, __Options_EntryStruct>(__memo_context, ((__memo_id) + (204012763)), style, ((): EntryStruct => {
      return new EntryStruct(false, ({let gensym___29142858 = storage;
      (((gensym___29142858) == (null)) ? undefined : gensym___29142858())}));
    }), initializers, reuseId, content);
  }
  ...
  @ComponentBuilder() 
  public static $_invoke(initializers?: __Options_EntryStruct, storage?: LocalStorage, @Builder() @Memo() content?: ((__memo_context: __memo_context_type, __memo_id: __memo_id_type)=> void)): EntryStruct {
    throw new Error("Declare interface");
  }
  ...
  public build(__memo_context: __memo_context_type, __memo_id: __memo_id_type) {
    ...
    ColumnImpl(__memo_context, ((__memo_id) + (257873411)), @Memo() ((__memo_context: __memo_context_type, __memo_id: __memo_id_type, instance: ColumnAttribute): void => {
      ...
      aNamespace.ExportEntryStruct._invoke(__memo_context, ((__memo_id) + (172290133)), undefined, undefined, undefined, undefined, undefined);
      {
        __memo_scope.recache();
        return;
      }
...
@Component() final struct V1Struct extends CustomComponent<V1Struct, __Options_V1Struct> {
  ...
  public build(__memo_context: __memo_context_type, __memo_id: __memo_id_type) {
    ...
    ColumnImpl(__memo_context, ((__memo_id) + (215219604)), @Memo() ((__memo_context: __memo_context_type, __memo_id: __memo_id_type, instance: ColumnAttribute): void => {
      ...
      aNamespace.ExportStructV1._invoke(__memo_context, ((__memo_id) + (225484108)), undefined, undefined, undefined, undefined, undefined);
      aNamespace.ExportStructV1WithBody._invoke(__memo_context, ((__memo_id) + (136286509)), undefined, (() => {
        return {
          __backing_someLink: this.__backing_aNumber,
          __options_has_someLink: true,
        };
...
@ComponentV2() final struct V2Struct extends CustomComponentV2<V2Struct, __Options_V2Struct> {
  ...
  public build(__memo_context: __memo_context_type, __memo_id: __memo_id_type) {
    ...
    ColumnImpl(__memo_context, ((__memo_id) + (34887364)), @Memo() ((__memo_context: __memo_context_type, __memo_id: __memo_id_type, instance: ColumnAttribute): void => {
      ...
      aNamespace.ExportStructV2._invoke(__memo_context, ((__memo_id) + (53444768)), undefined, undefined, undefined, undefined, undefined);
      aNamespace.ExportStructV2WithBody._invoke(__memo_context, ((__memo_id) + (219763513)), undefined, (() => {
        return {
          someParam: this.aNumber,
          __options_has_someParam: true,
          someRequiredParam: this.aNumber,
...
class __EntryWrapper extends EntryPoint {
  ...
  public entry(__memo_context: __memo_context_type, __memo_id: __memo_id_type): void {
    ...
    EntryStruct._invoke(__memo_context, ((__memo_id) + (125892063)), undefined, undefined, undefined, undefined, undefined);
    {
      __memo_scope.recache();
      return;
    }
...
pluginTester.run(
    'test declarations in namespace',
    ...
    {
        stopAfter: 'checked',
        tracing: { externalSourceNames: ['mock.demo.mock.declarations.utils.namespace'] }
    }
);

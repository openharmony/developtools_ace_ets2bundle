...
export class StoragePropTranslator extends PropertyTranslator implements InitializerConstructor, GetterSetter {
    ...
    generateInitializeStruct(left: arkts.Expression, insideMemberExpression: arkts.MemberExpression): arkts.AstNode {
        ...
        return arkts.factory.createIfStatement(
            ...
            arkts.factory.createBlock(
                [arkts.factory.createExpressionStatement(
                    arkts.factory.createCallExpression(member, undefined, [insideMemberExpression]))]
            )
        );
    }
}